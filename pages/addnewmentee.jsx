              ...
              <Form>
                ...
                <fieldset>
                  <Form.Group as={Row} className="mb-3">
                    ...
                    <Col sm={5}>
                      <Form.Check onChange={(e) => setEducationcategory(e.target.value)} type="radio" value="informatics" label="informatics" name="formVerticalRadios" id="formVerticalRadios1" />
                    </Col>
                    <Col sm={5}>
                      <Form.Check onChange={(e) => setEducationcategory(e.target.value)} type="radio" value="non-informatics" label="non-informatics" name="formVerticalRadios" id="formVerticalRadios2" />
                    </Col>
                  </Form.Group>
                </fieldset>
                <Form.Group as={Row} className="mb-3" controlId="formPlaintext">
